...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "rohitchintam15492001@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Robinson Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Robinson Electronics.<br>"
					...
					+ "<span class='greenText'>ROBINSON500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
